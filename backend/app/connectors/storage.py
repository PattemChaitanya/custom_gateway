...
class AzureBlobStorageConnector(StorageConnector):
    ...
    async def connect(self):
        ...
        raise NotImplementedError(
            "Azure connector requires azure-storage-blob package")
...
# Backwards-compatible S3Connector expected by tests
class S3Connector:
    def __init__(self, region: str = "us-east-1", access_key_id: str = None, secret_access_key: str = None, bucket_name: str = None, **kwargs):
        self.region = region
    ...
    async def connect(self):
        # lightweight no-op connect for tests
        return
